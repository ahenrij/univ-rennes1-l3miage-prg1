 ...
 *
 *        Les arbres binaires sont construits par chaînage par références pour
 *        les fils et une pile de pères.
 */
public class BinaryTree<T> {
	...
	public class TreeIterator implements Iterator<T> {
		...
		public NodeType nodeType() {
			...
			/* we ensure both left and right childs are not null to avoid NPE
			 whether the implementation change or not */
		...
		public void remove() {
			...
			currentNode.value = element.value;
			currentNode.left = element.left;
			currentNode.right = element.right;
		}

		/**
		 * Vider le sous–arbre référencé par le noeud courant, qui devient butoir.
		 */
		@Override
		public void clear() {
